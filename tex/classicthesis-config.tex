...
% ****************************************************************************************************
\newcommand{\myTitle}{Hybrid Heat Pump Analysis\xspace}
\newcommand{\mySubtitle}{The optimisation of a heat pump--gas boiler combination in a residential home\xspace}
...
\newcommand{\myCollaborator}{Prof. Dr. Mohammad Saffari\xspace}
...
\newcommand{\myPrintLocation}{Ballsbridge, Dublin 6, Ireland}
...
\newcommand{\mysubject}{Analysis of a Hybrid Heat Pump Configuration in a Residential Home, Mechanical Engineering}
