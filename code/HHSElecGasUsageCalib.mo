...
model HHSFinalModel
 ...
 "Pump on"
  ...
  inner Buildings.ThermalZones.EnergyPlus_9_6_0.Building building(
    ...
    Irish_Reference_Home(v960)_Minimal.idf",
    epwName="E:/Documents/ThesisNumericalSim/Weather/Clones/
    IRL_Clones.039740_IWEC.epw",
    weaName="E:/Documents/ThesisNumericalSim/Weather/Clones/
    IRL_Clones.039740_IWEC.mos",
 ...
 "Setpoint HP"
  ...
  Buildings.Fluid.Sensors.TemperatureTwoPort TempPreHP(redeclare package Medium
      = MediumW,
    allowFlowReversal=falsem_flow_nominal=mBoi_flow_nominal); Buildings.Fluid.Sensors.TemperatureTwoPort TemPostHP(redeclare package Medium
      = MediumW,
    allowFlowReversal=falsem_flow_nominal=mBoi_flow_nominal); Modelica.Blocks.Logical.LessThreshold lesThrTOut(threshold=TempBlockBoi)
  ...
  Modelica.Blocks.Logical.GreaterThreshold greaterThreshold(threshold=
        TempBlockHP)
    "Block\acsfont{HP}if TOut is less than 2C"
...
connect(prescribedTemperature.port, boi1.heatPort);
    ...
    experiment(
      StopTime=31536000Tolerance=1e-06__Dymola_Algorithm="Radau"),
    __Dymola_experimentFlags(
      Advanced(GenerateVariableDependencies=false, OutputModelicaCode=false)Evaluate=falseOutputCPUtime=falseOutputFlatModelica=false));
end HHSFinalModel;
