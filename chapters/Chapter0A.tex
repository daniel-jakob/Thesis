...
\chapter{\texttt{Modelica} Code Listing}
...
\begin{longlisting}
    \caption{\texttt{Modelica} source code for final \acs{HHS} model. Source available at \url{https://github.com/daniel-jakob/ThesisModelica}}
    \inputminted[bgcolor=lightgray!30,]{modelica}{code/HHSElecGasUsageCalib.mo}
    \label{listing:XXX}
\end{longlisting}