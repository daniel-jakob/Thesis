...
\begin{enumerate}
    ...
    \item\label{itm:typography} Typography:
        \begin{enumerate}
            \item\label{itm:style}\texttt{style}: this offers a comfortable way of changing the look and feel easily. Default style is \texttt{classicthesis}. 
...
\begin{figure}[htb]
    \setlength{\maxfigurewidth}{\dimexpr(\textwidth-2em)/2}
    \centering
    \begin{subfigure}[t]{\maxfigurewidth}
        \centering
        \includegraphics[width=\textwidth]{example-image-a}
        \caption{Control panel and three load cell readers}
        \label{subfig:balance}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{\maxfigurewidth}
        \centering
        \includegraphics[width=\textwidth]{example-image-a}
        \caption{Water manometer}
        \label{subfig:water_manometer}
    \end{subfigure}
    \begin{subfigure}[t]{\maxfigurewidth}
        \centering
        \includegraphics[width=\textwidth]{example-image-a}
        \caption{Differential manometer}
        \label{subfig:differential_manometer}
    \end{subfigure}
    \hfill
    \begin{subfigure}[t]{\maxfigurewidth}
        \centering
        \includegraphics[width=\textwidth]{example-image-a}
        \caption{Windtunnel exit}
        \label{subfig:wind_tunnel}
    \end{subfigure}
    \caption[exp.]{Experiment equipment}
...
\crefrange{subfig:balance}{subfig:water_manometer}. \cref{sec:custom,sec:issues}
\cref{tab:example}\cref{eq:kappa}\cref{lst:useless} \cref{itm:style} \cref{itm:typography}
\cref{ch:examples}\cref{pt:manual} \cref{para:example}
