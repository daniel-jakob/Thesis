...
Climatic weather data obtained from the OneBuilding weather database \cite{onebuilding_climateonebuildingorg_nodate} in the \texttt{.epw} filetype and produced by ASHRAE. The weather data file used in this study is a product of an amalgamation of representative monthly weather data from a year occurring between 2020 and 2008 for each of the twelve months. This weather data was collected by the Clones weather station Operated by Met Éireann, located 16.5 kilometres away from Belturbet. 
