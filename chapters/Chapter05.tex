...
\begin{table}[htb]
    ...
    \pgfplotstabletypeset[
        ...
        color cells={min=1684.5,max=1876.66,textcolor=-mapped color!50!black},
        /pgfplots/colormap name=mycolor,
        every head row/.style={%
            output empty row,
            before row={%
                \diagbox[width=4em,height=2em]{$T_\mathrm{cut}$}{$T_\mathrm{biv}$} & $-$2 & $-$1 & 0 & 1 & 2 & 3& 4\\
                },
            },
...
\begin{table}[htb]
    ...
    \pgfplotstabletypeset[
        col sep=space,
        /pgf/number format/1000 sep= ,\rightarrow
        color cells={min=1684.5,max=1876.66,textcolor=-mapped color!50!black},
        /pgfplots/colormap name=mycolor,
        every head row/.style={%
            output empty row,
